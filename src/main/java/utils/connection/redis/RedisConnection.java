package utils.connection.redis;
...
public class RedisConnection {
    ...
    public void init(Logger logger, String targetPropertiesPath){
        ...
        try {
            ...
            DB = properties.getProperty("db") != null ? Integer.parseInt(properties.getProperty("db")) : DB;
    ...
    private void _init(){
        try {
            ...
            jedisPool = new JedisPool(config, IP, PORT, TIMEOUT, AUTH, DB);
