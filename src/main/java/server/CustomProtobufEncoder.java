...
public class CustomProtobufEncoder extends MessageToByteEncoder<CBMessage.Response> {

    @Override
    protected void encode(ChannelHandlerContext ctx, CBMessage.Response msg, ByteBuf out)
            throws Exception {
